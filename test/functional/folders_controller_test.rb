...
class FoldersControllerTest < ActionController::TestCase
  ...
  test "should create folder" do
    assert_difference('Folder.count') do
      post :create, folder: { description: @folder.description, path: @folder.path, title: @folder.title, url: @folder.url }
    end
  ...
  test "should update folder" do
    put :update, id: @folder, folder: { description: @folder.description, path: @folder.path, title: @folder.title, url: @folder.url }
    assert_redirected_to folder_path(assigns(:folder))
  end
